...
- Agent 3: UI + Graph builds the graph canvas, inspector, and keyboard UX using the published API/WS shapes and node state model; diffs/artifacts must appear per node.
