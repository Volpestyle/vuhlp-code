...
export function ThinkingSpinner({
  ...
  const sizeWarningRef = useRef(false);
  const pixelSize = SIZE_MAP[size];
  const resolvedSize = pixelSize ?? SIZE_MAP.sm;

  if (!pixelSize && !sizeWarningRef.current) {
    console.warn('[thinking-spinner] invalid size, defaulting to sm', { size });
